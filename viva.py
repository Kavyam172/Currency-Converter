...
class App(tk.Tk):
    ...
    def __init__(self, converter):
        ...
        # Label
        self.intro_label = tkinter.Label(self, text='Welcome to Real Time Currency Convertor', fg='blue', relief=tk.RAISED,
                                         borderwidth=3,bg='white')
        self.intro_label.config(font=('Courier', 15, 'bold'))

        self.date_label = tkinter.Label(self,
                                        text=f"1 Indian Rupee equals = {self.currency_converter.convert('INR', 'USD', 1)} USD \n Date : {self.currency_converter.data['date']}",
                                        relief=tk.GROOVE, borderwidth=5,bg='#E0E0FF')
        ...
        self.amount_field = tkinter.Entry(self, bd=3, relief=tk.RIDGE, justify=tk.CENTER, validate='key', validatecommand=valid)
        self.converted_amount_field_label = tkinter.Label(self, text='', fg='black', bg='white', relief=tk.RIDGE,
        ...
        # Convert button
        self.convert_button = tkinter.Button(self, text="Convert", fg="black", command=self.perform)
